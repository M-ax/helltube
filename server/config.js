...
export const config = {
  ...
  desktopIceServers: process.env.DESKTOP_ICE_SERVERS || '[]',
  desktopTurnSecret: process.env.DESKTOP_TURN_SECRET || '',
  desktopIceTransportPolicy: process.env.DESKTOP_ICE_TRANSPORT_POLICY || 'all',
  desktopMaxViewers: Number(process.env.DESKTOP_MAX_VIEWERS || 50),
  desktopListenIp: process.env.DESKTOP_LISTEN_IP || '127.0.0.1',
  desktopAnnouncedAddress: process.env.DESKTOP_ANNOUNCED_ADDRESS || '',
  desktopPort: Number(process.env.DESKTOP_PORT || 44444),
  spotifyDesktopKey: process.env.SPOTIFY_DESKTOP_KEY || '',
  spotifyDesktopKnownHosts: process.env.SPOTIFY_DESKTOP_KNOWN_HOSTS || '',
  spotifyDesktopPort: Number(process.env.SPOTIFY_DESKTOP_PORT || 22022),
